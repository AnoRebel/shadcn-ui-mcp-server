...
export const setupHandlers = (server: Server): void => {
  ...
  server.setRequestHandler(ReadResourceRequestSchema, async request => {
    return await handleRequest("read_resource", request.params, async (validatedParams: any) => {
  ...
  server.setRequestHandler(GetPromptRequestSchema, async request => {
    return await handleRequest("get_prompt", request.params, async (validatedParams: any) => {
  ...
  server.setRequestHandler(CallToolRequestSchema, async request => {
    return await handleRequest("call_tool", request.params, async (validatedParams: any) => {
