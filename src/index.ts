...
async function setupCommandLine() {
  ...
  program
    ...
    .option("-f, --framework <framework>", "Framework to use: vue, react or svelte", "vue")
...
Environment Variables:
  ...
  FRAMEWORK                       Framework to use: 'vue', 'react' or 'svelte' (default: vue)
...
For more information:
  https://github.com/AnoRebel/shadcn-ui-mcp-server
`)
  })
